...
insert into osastoHenkilo (osastoId, henkiloId, toimi) values(1,1,'koodari');
insert into osastoHenkilo (osastoId, henkiloId,  toimi   ) values(1,4,'tukihenkilö');
insert into osastoHenkilo (osastoId, henkiloId, toimi) values(3,2,'skuskaaja');
insert into osastoHenkilo (osastoId, henkiloId, toimi) values(2,5,  'johtaja');
insert into osastoHenkilo (osastoId, henkiloId, toimi) values(3,3, 'kuljettaja');
